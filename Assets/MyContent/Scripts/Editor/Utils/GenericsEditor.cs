...
namespace EditorGenerics
{
    ...
    public static class TextStyles
    {
        ...
        public static GUIStyle H1 => new GUIStyle(_h1);
        public static GUIStyle H2 => new GUIStyle(_h2);
        public static GUIStyle H3 => new GUIStyle(_h3);
        public static GUIStyle H4 => new GUIStyle(_h4);
        public static GUIStyle H5 => new GUIStyle(_h5);
        public static GUIStyle H6 => new GUIStyle(_h6);
        public static GUIStyle H7 => new GUIStyle(_h7);
